package org.zcy.agriculture.merchant.util;
...
public class ExcelUtil<T> {
     ...
     */
    public void exportExcelByStream(List<T> list, String sheetName, HttpServletResponse httpServletResponse) {
        this.init(list, sheetName, Type.EXPORT);
    ...
    /**
     * 对list数据源将其里面的数据导入到excel表单
     * @param httpServletResponse null 导出到本地磁盘D:/ZCY；非空 流方式导出
     * @return
     */
    public AjaxResult exportExcel(HttpServletResponse httpServletResponse) {
...
//            String filename = encodingFilename(sheetName);
            ...
            //流或者本地的方式
            if(!ValidationUtil.isEmpty(httpServletResponse)) {
    ...
    public String getAbsoluteFile(String filename) {
        String downloadPath = "D:/ZCY/agriculture/download/" + filename;
