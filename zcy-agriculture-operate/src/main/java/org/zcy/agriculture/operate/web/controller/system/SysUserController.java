...
import org.zcy.agriculture.operate.framework.shiro.service.SysPasswordService;
...
import org.zcy.agriculture.service.system.ISysPostService;
...
public class SysUserController extends BaseController
{
    ...
    {
        if (StringUtilsOp.isNotNull(user.getUserId()) && SysUser.isAdmin(user.getUserId()))
        {
