package org.zcy.agriculture.operate.generator.service.impl;
...
import org.zcy.agriculture.admin.mapper.GenMapper;
...
import org.zcy.agriculture.operate.generator.service.IGenService;
import org.zcy.agriculture.operate.generator.util.GenUtils;
import org.zcy.agriculture.operate.generator.util.VelocityInitializer;
...
public class GenServiceImpl implements IGenService
{
    ...
    public void generatorCode(TableInfo table, List<ColumnInfo> columns, ZipOutputStream zip)
    {
        ...
        table.setClassname(StringUtilsOp.uncapitalize(className));
        // 列信息
        ...
        for (String template : templates)
        {
            ...
            Template tpl = Velocity.getTemplate(template, ConstantsOp.UTF8);
            tpl.merge(context, sw);
            try
            {
                // 添加到zip
                zip.putNextEntry(new ZipEntry(GenUtils.getFileName(template, table, moduleName)));
                IOUtils.write(sw.toString(), zip, ConstantsOp.UTF8);
