package org.zcy.agriculture.operate.framework.aspectj;
...
import org.zcy.agriculture.operate.common.enums.BusinessStatus;
...
public class LogAspect
{
    ...
    // 配置织入点
    @Pointcut("@annotation(org.zcy.agriculture.constants.Log)")
    ...
    protected void handleLog(final JoinPoint joinPoint, final Exception e)
    {
        try
        {
            ...
            if (currentUser != null)
            {
                ...
                if (StringUtilsOp.isNotNull(currentUser.getDept())
                        && StringUtilsOp.isNotEmpty(currentUser.getDept().getDeptName()))
                {
            ...
            if (e != null)
            {
                ...
                operLog.setErrorMsg(StringUtilsOp.substring(e.getMessage(), 0, 2000));
            }
            // 设置方法名称
    ...
    private void setRequestValue(SysOperLog operLog) throws Exception
    {
        ...
        operLog.setOperParam(StringUtilsOp.substring(params, 0, 2000));
    }
