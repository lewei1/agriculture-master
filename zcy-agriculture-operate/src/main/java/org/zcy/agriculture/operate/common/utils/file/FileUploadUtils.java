package org.zcy.agriculture.operate.common.utils.file;
...
import org.zcy.agriculture.operate.common.exception.file.FileNameLengthLimitExceededException;
import org.zcy.agriculture.operate.common.exception.file.FileSizeLimitExceededException;
import org.zcy.agriculture.operate.common.utils.DateUtilsOp;
import org.zcy.agriculture.operate.common.utils.Md5UtilsOp;
...
public class FileUploadUtils
{
    ...
    public static final String extractFilename(MultipartFile file, String extension)
    {
        ...
        filename = DateUtilsOp.datePath() + "/" + encodingFilename(filename) + extension;
        return filename;
    }
    ...
    private static final File getAbsoluteFile(String uploadDir, String filename) throws IOException
    {
        ...
        File desc = new File(path.replace("\\\\","\\"));
    ...
    private static final String encodingFilename(String filename)
    {
        ...
        filename = Md5UtilsOp.hash(filename + System.nanoTime() + counter++);
        return filename;
    }
