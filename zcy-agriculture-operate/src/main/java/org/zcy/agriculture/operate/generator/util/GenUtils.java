package org.zcy.agriculture.operate.generator.util;
...
import org.zcy.agriculture.admin.entity.ColumnInfo;
import org.zcy.agriculture.admin.entity.TableInfo;
...
public class GenUtils
{
    ...
    public static List<ColumnInfo> transColums(List<ColumnInfo> columns)
    {
        ...
        {
            // 列名转换成Java属性名
            String attrName = StringUtilsOp.convertToCamelCase(column.getColumnName());
            column.setAttrName(attrName);
            column.setAttrname(StringUtilsOp.uncapitalize(attrName));
    ...
    public static VelocityContext getVelocityContext(TableInfo table)
    {
        ...
        velocityContext.put("datetime", DateUtilsOp.getDate());
    ...
    public static String tableToJava(String tableName)
    {
        ...
        if (ConstantsOp.AUTO_REOMVE_PRE.equals(autoRemovePre) && StringUtilsOp.isNotEmpty(tablePrefix))
        {
            tableName = tableName.replaceFirst(tablePrefix, "");
        }
        return StringUtilsOp.convertToCamelCase(tableName);
    }
    ...
    public static String getModuleName(String packageName)
    {
        ...
        String moduleName = StringUtilsOp.substring(packageName, lastIndex + 1, nameLength);
        return moduleName;
    }
    ...
    {
        int lastIndex = packageName.lastIndexOf(".");
        String basePackage = StringUtilsOp.substring(packageName, 0, lastIndex);
        return basePackage;
    }
