package org.zcy.agriculture.operate.framework.web.base;
...
public class BaseController
{
    ...
    public void initBinder(WebDataBinder binder)
    {
        ...
        binder.registerCustomEditor(Date.class, new PropertyEditorSupport()
        {
            ...
            {
                setValue(DateUtilsOp.parseDate(text));
            }
        });
    }
    ...
    protected void startPage()
    {
        ...
        if (StringUtilsOp.isNotNull(pageNum) && StringUtilsOp.isNotNull(pageSize))
        {
    ...
    {
        return StringUtilsOp.format("redirect:{}", url);
    }
